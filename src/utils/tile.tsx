...
export function moveTile( {tileList, x, y}: Props ) {
  ...
  const sorted = tileList
                  ...
                  .sort((a, b) => {
                    ...
                    if(res) return res;
                      ...
                      if (isMoveY) return isMinus ? a.yPos-b.yPos : b.yPos-a.yPos;
                      else return isMinus ? a.xPos-b.xPos : b.xPos-a.xPos;
                    }
  ...
  console.log(newTileList.filter(item => !item.isDisabled));
